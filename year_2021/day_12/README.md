...
<h1>Day 12: Passage Pathing 🎄</h1><p>Copyright (c) Eric Wastl</p><a href=https://adventofcode.com/2021/day/12>Link to Day 12</a><h2>Part One 🎁</h2><p>With your <span title="Sublime.">submarine's subterranean subsystems subsisting suboptimally</span>, the only way you're getting out of this cave anytime soon is by finding a path yourself. Not just <b>a</b> path - the only way to know if you've found the <b>best</b> path is to find <b>all</b> of them.</p>
...
<p><b>How many paths through this cave system are there that visit small caves at most once?</b></p>
...
<p>You can also <span class="share">[Share<span class="share-content">on
  ...
  <a href="javascript:void(0);" onclick="var mastodon_instance=prompt('Mastodon Instance / Server Name?'); if(typeof mastodon_instance==='string' && mastodon_instance.length){this.href='https://'+mastodon_instance+'/share?text=%22Passage+Pathing%22+%2D+Day+12+%2D+Advent+of+Code+2021+%23AdventOfCode+https%3A%2F%2Fadventofcode%2Ecom%2F2021%2Fday%2F12'}else{return false;}" target="_blank">Mastodon</a
