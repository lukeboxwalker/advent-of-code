...
<h1>Day 4: Camp Cleanup 🎄</h1><p>Copyright (c) Eric Wastl</p><a href=https://adventofcode.com/2022/day/4>Link to Day 4</a><h2>Part One 🎁</h2><p>Space needs to be cleared before the last supplies can be unloaded from the ships, and so several Elves have been assigned the job of cleaning up sections of the camp. Every section has a unique <b>ID number</b>, and each Elf is assigned a range of section IDs.</p>
